...
CATEGORIES = [
    ...
    # {"name": "Women Jeans 1", "url": "https://www.myntra.com/women-jeans"},
    {"name": "Women Trousers 1", "url": "https://www.myntra.com/women-trousers"},
]
NUM_PAGES = 25
...
async def scrape_all_pages_for_category(context, category):
    ...
    try:
        for page_num in range(18, NUM_PAGES + 1):
